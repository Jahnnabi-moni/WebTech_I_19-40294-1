...
if($check==0){
    ...
    'compadrsErr' => $compadrsErr
      ...
      header("location:../corporateEmployerReg.php?" . http_build_query($value));
   }
 ...
 if($check == 1 )
 {
  ...
  if (addCorporateEmployee($tableName,$data)) {
    header('Location: ../welcome.php?successMsg=' . 'Data Added Successfully');
  }
   else{
        $dberror = '<br><label>Data Not stored in database<br>';
           header("location:../corporateEmployerReg.php?jsonmsg=" . $dberror);  
  }
