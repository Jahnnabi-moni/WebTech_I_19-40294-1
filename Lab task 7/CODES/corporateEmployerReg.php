...
<div class="row">
  ...
  <span class="error"><?php if(!empty($_GET['userNameErr'])){echo $_GET['userNameErr'];}?></span><br><hr>
...
<div class="row">
  ...
  <span class="error"><?php if(!empty($_GET['emailErr'])){echo $_GET['emailErr'];}?></span><br><hr>
 ...
 <div class="row">
    ...
    <div class="col-75">
      <input type="tel" id="phone" name="phone" placeholder="01234567891">
    </div>
  </div>
  ...
  <span class="error"><?php if(!empty($_GET['passErr'])){echo $_GET['passErr'];}?></span><br><hr>
   ...
   <div class="row">
    ...
    <div class="col-75">
      <input type="password" id="cpassword" name="cpasssword" placeholder="Confirm Your Password">
    </div>
  </div>
 ...
 <div class="row">
  ...
  <span class="error"><?php if(!empty($_GET['compnameErr'])){echo $_GET['compnameErr'];}?></span><br><hr>
 ...
 <div class="row">
    ...
    <div class="col-75">
      <textarea id="compaddress" name="compaddress" placeholder="Write something.." rows="4"></textarea>
    </div>
  </div>
  <span class="error"><?php if(!empty($_GET['compadrsErr'])){echo $_GET['compadrsErr'];}?></span><br><hr>
  ...
  <span class="error"><?php if(!empty($_GET['licenseErr'])){echo $_GET['licenseErr'];}?></span><br><hr>
